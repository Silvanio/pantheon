# company-task-labels Specification

## Purpose
Defines the company-admin-managed catalog of predefined, reusable Tasks-board labels, configured from Company Settings alongside task columns and reused across every obra of the company.
