...
## Purpose
Defines the "Pedido de Compra" (purchase request) flow: grouping requested materials under a named header per construction site and converting a header's pending items into an Orçamento.
