 ...
 * URL and the raw token carried in the event.
 */
@Component
public class InvitationEmailHandler {
    ...
    public void handle(JsonNode payloadNode) {
        ...
        String subject = "Convite para a obra " + payload.projectName() + " no Pantheon";
        ...
        body.append(inviter)
                .append(" convidou você para participar da obra \"")
