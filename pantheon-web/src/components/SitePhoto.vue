...
<template>
  <img v-if="objectUrl" :src="objectUrl" class="h-full w-full object-cover" alt="" />
  <div v-else class="flex h-full w-full items-center justify-center bg-steel-100 text-steel-400 dark:bg-steel-700 dark:text-steel-500">
